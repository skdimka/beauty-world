...
let ExpressLoader = class ExpressLoader extends abstract_loader_1.AbstractLoader {
    register(httpAdapter, optionsArr) {
        ...
        const express = load_package_util_1.loadPackage('express', 'ServeStaticModule', () => require('express'));
        optionsArr.forEach(options => {
            ...
            const renderFn = (req, res, next) => {
                if (!is_route_excluded_util_1.isRouteExcluded(req, options.exclude)) {
            ...
            if (options.serveRoot) {
                ...
                const renderPath = typeof options.serveRoot === 'string'
                    ? options.serveRoot + validate_path_util_1.validatePath(options.renderPath)
                    : options.serveRoot;
